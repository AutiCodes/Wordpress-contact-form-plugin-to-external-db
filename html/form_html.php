<?php
	...
	echo '<input type="text" name="lastname" size="40" required/>';
	echo '</p>';

    // Address
	echo '<p>';
	echo '<strong>Adres</strong> (vereist) <br/>';
	echo '<input type="text" name="address" size="40" required/>';
	echo '</p>';
    
    // City
	echo '<p>';
	echo '<strong>Woonplaats</strong> (vereist) <br/>';
	echo '<input type="text" name="city" size="40" required/>';
	echo '</p>';
	
    // Postcode
	echo '<p>';
	echo '<strong>Postcode</strong> (vereist) <br/>';
	echo '<input type="text" name="postal_code" size="40" required/>';
	echo '</p>';
	
    // Email
	echo '<p>';
	echo '<strong>Email</strong> (vereist) <br/>';
	echo '<input type="text" name="email" size="40" required/>';
	echo '</p>';	

    // Phonenumber
	echo '<p>';
	echo '<strong>Telefoonnummer</strong> (vereist) <br/>';
	echo '<input type="text" name="phone" size="40" required/>';
	echo '</p>';		

    // Birthdate
	echo '<p>';
	echo '<strong>Geboortedatum</strong> (DD-MM-YYYY) (vereist) <br/>';
	echo '<input type="text" name="birthdate" size="40" required/>';
	echo '</p>';	

    // Nationality
	echo '<p>';
	echo '<strong>Nationaliteit</strong> (vereist) <br/>';
	echo '<input type="text" name="nationality" size="40" required/>';
	echo '</p>';		
    ...
    echo '<label for="glider_brevet" style="padding-left: 5px;"> Zweef brevet A</label><br>';
    ...
    echo '<label for="heli_brevet" style="padding-left: 5px;"> Heli brevet A</label><br>';
    ...
    echo '<label for="drone_brevet_a3" style="padding-left: 5px;"> Drone EU A3</label><br>';
    ...
    echo '<label for="drone_brevet_a2" style="padding-left: 5px;"> Drone EU A2</label><br>';

    // RDW number
	echo '<p>';
	echo '<strong>RDW registratienummer</strong> <br/>';
	echo '<input type="text" name="rdw_number" size="40"/>';
	echo '</p>';		
	...
	echo '<input type="text" name="other_club_text" size="40"/>';
	echo '</p>';		 
	...
	echo '<input type="text" name="knvvl_text" size="40"/>';
	echo '</p>';		 

    // Wanne be member of TRMC at:
	echo '<p>';
	echo '<strong>Ik wil lid worden van de T.R.M.C. per</strong> (DD-MM-YYYY) (vereist) <br/>';
	echo '<input type="text" name="wanna_be_member_at" size="40" required/>';
	echo '</p>';	
